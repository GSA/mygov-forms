module FormHelpers
  def create_sample_forms
    @sample_form_1 = Form.create!(title: 'Sample Form 1', number: 'S-1', icr_reference_number: '201305-4040-001', omb_control_number: '4040-0001', omb_expiration_date: DateTime.parse("2016-06-30"))
    ...
    @sample_form_1.form_fields.create!(field_type: "date_select", name: 'date_field', label: 'A Date Field', description: 'This is a date field.')
